...
namespace SpineWise_Web
{
    public partial class MLModelspine
    {
        ...
        public class ModelInput
        {
            ...
            public string PressureSensor1 { get; set; }

            [LoadColumn(2)]
            [ColumnName(@"PressureSensor2")]
            public string PressureSensor2 { get; set; }

            [LoadColumn(3)]
            [ColumnName(@"PressureSensor3")]
            public string PressureSensor3 { get; set; }

            [LoadColumn(4)]
            [ColumnName(@"PressureSensor4")]
            public string PressureSensor4 { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("MLModelspine.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Good");
            if (labelColumn == null)
            {
                throw new Exception("Good column not found. Make sure the name searched for matches the name in the schema.");
            }
